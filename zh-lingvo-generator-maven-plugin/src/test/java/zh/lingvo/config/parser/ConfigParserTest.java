...
import zh.lingvo.config.parser.syntax.MapValue;
...
import static zh.lingvo.config.parser.SyntaxError.Type.MAP_NAME_MISSING;
import static zh.lingvo.config.parser.SyntaxError.Type.MISMATCHING_BRACE;
import static zh.lingvo.config.parser.SyntaxError.Type.MISMATCHING_BRACKET;
import static zh.lingvo.config.parser.SyntaxError.Type.SYNTAX_ERROR;
