...
import static zh.lingvo.config.parser.lexer.Lexer.State.COMMENT;
import static zh.lingvo.config.parser.lexer.Lexer.State.EOF;
import static zh.lingvo.config.parser.lexer.Lexer.State.ESCAPE;
import static zh.lingvo.config.parser.lexer.Lexer.State.NAME;
import static zh.lingvo.config.parser.lexer.Lexer.State.NEW_TOKEN;
import static zh.lingvo.config.parser.lexer.Lexer.State.SIMPLE_STRING;
import static zh.lingvo.config.parser.lexer.Lexer.State.SLASH;
import static zh.lingvo.config.parser.lexer.Lexer.State.STRING;
